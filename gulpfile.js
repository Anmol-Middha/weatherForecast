...
gulp.task('sass-compile',function () {
    return sass('./style/sass/main.scss',{style:'expanded',sourcemap:true})
...
// gulp.task('watchSassFiles',function(){
//     return gulpWatch('./style/sass/**/*.scss',{glob:'./style/sass/**/*.scss'},function(){
//         runSequence('watch-sass');
//     });
// });
// gulp.task('watchHtmlFiles',function(){
//     return gulpWatch('./*.html',{glob:'./*.html'},function(){
//         runSequence('watch-sass');
//     });
// });
//
// gulp.task('test',['watchHtmlFiles','watchSassFiles']);